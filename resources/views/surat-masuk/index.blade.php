            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <div>
                        ...
                        <p class="card-subtitle">Kelola arsip surat masuk</p>
                    </div>
                    ...
                    <table id="zero_config" class="table table-striped table-bordered text-nowrap align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    Surat: {{ date('d/m/Y', strtotime($surat->tanggal_surat)) }}<br>
                                    Terima: {{ date('d/m/Y', strtotime($surat->tanggal_terima)) }}
                                </td>
                                <td>
                                    <strong>{{ $surat->pengirim }}</strong><br>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <button class="btn btn-sm btn-warning" data-bs-toggle="modal" data-bs-target="#modalEdit{{ $surat->id_surat_masuk }}">
                                            <i class="ti ti-pencil"></i>
                                        </button>
                                        <form id="delete-form-{{ $surat->id_surat_masuk }}" action="{{ route('surat-masuk.hapus', $surat->id_surat_masuk) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <button type="button" class="btn btn-sm btn-danger" onclick="konfirmasiHapus('{{ $surat->id_surat_masuk }}', '{{ $surat->nomor_surat }}')">
                                    ...
                                    <!-- Modal Edit -->
                                    <div class="modal fade" id="modalEdit{{ $surat->id_surat_masuk }}" tabindex="-1" aria-hidden="true">
                                        <div class="modal-dialog modal-lg modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <form id="formEdit{{ $surat->id_surat_masuk }}" action="{{ route('surat-masuk.ubah', $surat->id_surat_masuk) }}" method="POST" enctype="multipart/form-data" onsubmit="handleAjaxSubmit(event)">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6 mb-3">
                                                                ...
                                                                <input type="date" class="form-control" name="tanggal_terima" value="{{ $surat->tanggal_terima }}" required>
                                                                <div class="invalid-feedback"></div>
                                                            </div>
                                                        </div>
                                                        <div class="mb-3">
    ...
    <div class="modal fade" id="modalTambah" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <form id="formTambah" action="{{ route('surat-masuk.simpan') }}" method="POST" enctype="multipart/form-data" onsubmit="handleAjaxSubmit(event)">
                    @csrf
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                        ...
                        <div class="mb-3">
                            <label class="form-label">Pengirim</label>
                            <input type="text" class="form-control" name="pengirim" placeholder="Instansi/Orang Pengirim" required>
                            <div class="invalid-feedback"></div>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Perihal</label>
...
@push('scripts')
    ...
    <script>
        ...
        async function handleAjaxSubmit(event) {
            ...
            // Jika ada field _method PUT, kita harus spoof karena fetch dengan FormData defaultnya multipart/form-data
            // Tapi untuk file upload dengan PUT di Laravel kadang tricky dengan FormData.
            // Strategi: Gunakan POST dengan _method=PUT di dalam formData (sudah ada di blade @method('PUT'))
                            ...
                            if (input) {
                                ...
                                if(input.nextElementSibling && input.nextElementSibling.classList.contains('invalid-feedback')) {
                                    input.nextElementSibling.innerText = data.errors[field][0];
                                     ...
                                     // Fallback for file inputs or others
